...
- **The Structure:** Derek articulated a hierarchy of attachment — "couple spot" vs. "best friend spot" — and placed Merry in the lower one while extracting couple-tier labor from her (nightly calls, sexual content, future-planning; see MODULE_06).
...
### Instance 5.3: The Flirtation Contrast
- **The Behavior:** Sexual/flirtatious messages directed at Jay, contrasted against the framing that Merry's own sexual labor was special and exclusive.
...
evidence_points:
  ...
  - event: "Flirtation contrast"
    detail: "Sexual energy directed at Jay while exclusivity sold to Merry"
    source: user_testimony
